...
#endif
#ifdef MUELU_BLOCKEDAMALGAMATIONFACTORY_SHORT
using BlockedAmalgamationFactory [[maybe_unused]] = MueLu::BlockedAmalgamationFactory<Scalar,LocalOrdinal,GlobalOrdinal,Node>;
#endif
