...
set(PROJECT_BINARY_DIR /home/a11bmafi/Library/trilinos/src-trilinos/cmake-build-debug)
set(TRIBITS_ENABLED_PACKAGES_BINARY_DIRS )

execute_process(
  COMMAND /home/a11bmafi/Apps/clion/bin/cmake/linux/bin/cmake -P "cmake_install.cmake"
...
if (NOT global_install_rtn EQUAL 0)
  ...
  foreach (pkg_binary_dir ${TRIBITS_ENABLED_PACKAGES_BINARY_DIRS})
    ...
    execute_process(COMMAND /home/a11bmafi/Apps/clion/bin/cmake/linux/bin/cmake -P cmake_install.cmake
  ...
  if (EXISTS "${set_installed_group_and_permissions_file}")
    ...
    execute_process(
      COMMAND /home/a11bmafi/Apps/clion/bin/cmake/linux/bin/cmake -P "${set_installed_group_and_permissions_file}"
